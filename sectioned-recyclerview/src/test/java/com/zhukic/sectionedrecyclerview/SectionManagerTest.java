...
public class SectionManagerTest {
    ...
    public void expandAllSections1() {
        ...
        sectionManager.collapseAllSections(true);
        ...
        sectionManager.expandAllSections(true);
